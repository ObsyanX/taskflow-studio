...
import { 
  CheckSquare, Target, Repeat, LogOut, Menu,
  Sun, Moon, BarChart3, Clock, BookOpen,
} from 'lucide-react';
...
export function MainLayout({ children }: MainLayoutProps) {
  ...
  const { notifications, markRead, markAllRead, deleteNotification, clearAll } = useAppNotifications();
